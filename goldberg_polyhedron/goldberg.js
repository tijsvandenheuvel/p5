...
function setup() {
	...
	specificPoints = drawPointsOnSphereByIds([
		1, 6, 7, 22, 23, 48, 49, 2, 11, 19, 42, 75,
	]);
...
function projectPointsOnSphere(pointsInTriangles) {
	...
	pointsInTriangles.forEach(function (points) {
		...
		points.forEach(function (p) {
			...
			pointsPerSphericTriangle.push(
				createVector(p.x * factor, p.y * factor, p.z * factor)
			);
		});
...
function getCooById(id) {
	...
	t5 = [
		110, 111, 112, 113, 114, 115, 116, 151, 152, 153, 154, 155, 191, 192,
		193, 232,
	];
	t4 = [
		117, 156, 157, 158, 194, 195, 196, 197, 198, 233, 234, 235, 236, 237,
		238, 239,
	];
	t15 = [
		118, 119, 120, 81, 82, 83, 84, 159, 160, 121, 122, 123, 199, 200, 161,
		240,
	];
	t10 = [
		85, 124, 125, 126, 162, 163, 164, 165, 166, 201, 202, 203, 204, 205,
		206, 207,
	];
	t13 = [
		86, 87, 88, 89, 90, 91, 92, 127, 128, 129, 130, 131, 167, 168, 169, 208,
	];
	t3 = [
		93, 132, 133, 134, 170, 171, 172, 173, 174, 209, 210, 211, 212, 213,
		214, 215,
	];
	t2 = [
		94, 95, 96, 97, 98, 99, 100, 135, 136, 137, 138, 139, 175, 176, 177,
		216,
	];
	t18 = [
		101, 140, 141, 142, 178, 179, 180, 181, 182, 217, 218, 219, 220, 221,
		222, 223,
	];
	t9 = [
		102, 103, 104, 105, 106, 107, 108, 143, 144, 145, 146, 147, 183, 184,
		185, 224,
	];
	t16 = [
		109, 148, 149, 150, 186, 187, 188, 189, 190, 225, 226, 227, 228, 229,
		230, 231,
	];
	t7 = [
		262, 263, 264, 265, 266, 267, 268, 291, 292, 293, 294, 295, 310, 311,
		312, 319,
	];
	t17 = [
		269, 270, 271, 272, 273, 274, 275, 296, 297, 298, 299, 300, 313, 314,
		315, 320,
	];
	t11 = [
		241, 242, 243, 244, 245, 246, 247, 276, 277, 278, 279, 280, 301, 302,
		303, 316,
	];
	t19 = [
		248, 249, 250, 251, 252, 253, 254, 281, 282, 283, 284, 285, 304, 305,
		306, 317,
	];
	t6 = [
		255, 256, 257, 258, 259, 260, 261, 286, 287, 288, 289, 290, 307, 308,
		309, 318,
	];
	// top
	if (t0.includes(id)) {
